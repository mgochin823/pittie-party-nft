...
export default class Dapp extends React.Component<Props, State> {
  ...
  componentDidMount = async () => {
    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError( 
        <>
          We were not able to detect <strong>MetaMask</strong>. We value <strong>privacy and security</strong> a lot so we limit your wallet options.<br />
          <br />
          But don't worry! <span className="emoji">😃</span> You can always interact with the smart-contract through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a><br />
          <br />
              ...
              <>
                ...
                {this.state.totalSupply < this.state.maxSupply ?
                  ...
                  <div className="collection-sold-out">
                    <h2>Pitties have <strong>sold out</strong>! <span className="emoji">🥳</span></h2>
        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              Hi there, if you're looking for a <strong>super-safe adoption experience </strong>
              you can interact with the smart-contract <strong>directly</strong> through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a>, without connecting your wallet to this DAPP!
