        ...
        {this.canMint() ?
          <div className="mint-widget">
            ...
            <div className="controls">
              ...
              <button className="primary" onClick={() => this.mint()}>Adopt!</button>
            </div>
          </div>
          :
          <div className="cannot-mint">
            ...
            {this.props.isWhitelistMintEnabled ? <>Opps, You are not included in the <strong>adoption list</strong>.</> : <>The contract is <strong>paused</strong>.</>}<br />
            Please come back during the next stage!
          </div>
        }
      </>
    );
